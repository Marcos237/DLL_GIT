        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "varchar(250)", unicode: false, nullable: false),
                    sigla = table.Column<string>(type: "varchar(2)", unicode: false, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdUser = table.Column<string>(type: "varchar(100)", maxLength: 450, nullable: false),
                    CPF = table.Column<string>(type: "varchar(11)", unicode: false, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Logradouro = table.Column<string>(type: "varchar(250)", unicode: false, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Endereco", x => x.Id);
                    table.ForeignKey(
                        name: "fk_UsuarioEndereco",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Navegador = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Celular = table.Column<string>(type: "varchar(11)", unicode: false, nullable: false)
                },
                constraints: table =>
                {
